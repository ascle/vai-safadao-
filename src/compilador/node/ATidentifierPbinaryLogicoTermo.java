...
public final class ATidentifierPbinaryLogicoTermo extends PPbinaryLogicoTermo
{
    private TTidentifier _tidentifier_;

    public ATidentifierPbinaryLogicoTermo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATidentifierPbinaryLogicoTermo(
    ...
    {
        ((Analysis) sw).caseATidentifierPbinaryLogicoTermo(this);
    }
