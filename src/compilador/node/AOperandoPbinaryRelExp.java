...
public final class AOperandoPbinaryRelExp extends PPbinaryRelExp
{
    private PPbinaryExpr _pbinaryExpr_;

    public AOperandoPbinaryRelExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOperandoPbinaryRelExp(
    ...
    {
        ((Analysis) sw).caseAOperandoPbinaryRelExp(this);
    }
