...
public final class ATidentifierPoperand extends PPoperand
{
    private TTidentifier _tidentifier_;

    public ATidentifierPoperand()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATidentifierPoperand(
    ...
    {
        ((Analysis) sw).caseATidentifierPoperand(this);
    }
