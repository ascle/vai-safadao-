...
public final class APbinaryRelExpPbinaryExpr extends PPbinaryExpr
{
    private PPbinaryRelExp _pbinaryRelExp_;

    public APbinaryRelExpPbinaryExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APbinaryRelExpPbinaryExpr(
    ...
    {
        ((Analysis) sw).caseAPbinaryRelExpPbinaryExpr(this);
    }
