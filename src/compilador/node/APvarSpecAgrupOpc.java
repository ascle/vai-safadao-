...
public final class APvarSpecAgrupOpc extends PPvarSpecAgrupOpc
{
    private TTigual _tigual_;
    private PPexpressionList _pexpressionList_;

    public APvarSpecAgrupOpc()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAPvarSpecAgrupOpc(this);
    }
