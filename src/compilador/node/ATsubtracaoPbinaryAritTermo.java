...
public final class ATsubtracaoPbinaryAritTermo extends PPbinaryAritTermo
{
    private TTidentifier _tidentifier_;

    public ATsubtracaoPbinaryAritTermo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATsubtracaoPbinaryAritTermo(
    ...
    {
        ((Analysis) sw).caseATsubtracaoPbinaryAritTermo(this);
    }
