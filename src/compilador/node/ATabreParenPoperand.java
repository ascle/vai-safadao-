...
public final class ATabreParenPoperand extends PPoperand
{
    ...
    public Object clone()
    {
        return new ATabreParenPoperand(
    ...
    {
        ((Analysis) sw).caseATabreParenPoperand(this);
    }
