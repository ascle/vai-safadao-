...
public final class APsignaturePmethodDeclAgrup extends PPmethodDeclAgrup
{
    private PPsignature _psignature_;

    public APsignaturePmethodDeclAgrup()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APsignaturePmethodDeclAgrup(
    ...
    {
        ((Analysis) sw).caseAPsignaturePmethodDeclAgrup(this);
    }
